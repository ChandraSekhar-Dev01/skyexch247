  ...
  return (
    <div className="fixed top-0 w-full h-full m-0 bg-[#fff] rounded-none shadow-none">
      ...
      <div className="p-[16px_24px] mt-[40px] text-[14px] leading-[24px] overflow-y-scroll h-[95vh]">
        <div className="text-[13px] leading-[1.4] font-normal p-[15px] m-[10px_0] rounded-[8px] bg-[#aed5f5]">
          NOTE:
          <br />
          Players using VPN and login from different IP frequently may result to void
          bets.
          <br />
          And on the basis of different IP from multiple city we can suspend the account
          and void bets.
        </div>
        ...
        <ol className='list-decimal ml-[32px] mb-[16px]'>
          ...
          <li>
            Any self matching ( punching ) bets on non favorite teams when liquidity is
            low will be voided even if the player account is in minus for the event ,
            the upline will be responsible for the same.
          </li>
          <li>
            Please note that if any account has been locked due to ‘any sort of cheating
            or suspicious’ within the last 72 hours, Company reserves the right to void
            any bet of this nature within the account irrespective of when the bet was
            placed.
          </li>
          <li>
          ...
          <li>
            ...
            such as technical delayed suspension from the provider. In any such case Sky
            Exchange will settle according to Betfair.com
          </li>
          <li>
          ...
          <li>
            ...
            reserves to the right to void bets from accounts found to be exceeding these
            limits by using multiple accounts across this and any other associated
            sites.
          </li>
          <li>
        ...
        <h1 className='m-[40px_0_24px_0] text-[22px] text-[#000] font-bold underline'>Exchange Rules and Regulations</h1>
        <h2 className='m-[16px_0] p-0 text-[20px] text-[#1b2d38] font-bold border-b border-[#ccc] pb-[8px]'>Part A - Introduction</h2>
        <h3 className='mt-[16px_0] text-[18px] text-[#1e1e1ee6] font-bold'>Restricted territory information</h3>
        <p>
        ...
        <h3 className='mt-[16px_0] text-[18px] text-[#1e1e1ee6] font-bold'>1. Use and interpretation</h3>
        <p>
        ...
        <h3 className='mt-[16px_0] text-[18px] text-[#1e1e1ee6] font-bold'>2. Market information</h3>
        <p>
        ...
        <h3 className='mt-[16px_0] text-[18px] text-[#1e1e1ee6] font-bold'>3. Customer responsibility</h3>
        <p>
        ...
        <h3 className='mt-[16px_0] text-[18px] text-[#1e1e1ee6] font-bold'>4. Customer betting disputes &amp; IBAS</h3>
        <p>
        ...
        <h2 className='m-[16px_0] p-0 text-[20px] text-[#1b2d38] font-bold border-b border-[#ccc] pb-[8px]'>Part B - General rules</h2>
        <h3 className='mt-[16px_0] text-[18px] text-[#1e1e1ee6] font-bold'>1. Managing markets In-Play</h3>
        <h4 className='ml-[8px] text-[14px] text-[#1e1e1ee6] font-bold'>a) General</h4>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
            ...
            relevant time, then:
            <ul className='ml-[32px] mb-[16px]' style={{ listStyleType: 'circle' }}>
              <li>
        ...
        <h4 className='ml-[8px] text-[14px] text-[#1e1e1ee6] font-bold'>
        ...
        <h4 className='ml-[8px] text-[14px] text-[#1e1e1ee6] font-bold'>d) In-play Australian markets</h4>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
        ...
        <h3 className='mt-[16px_0] text-[18px] text-[#1e1e1ee6] font-bold'>2. Results and market settlement</h3>
        <h4 className='ml-[8px] text-[14px] text-[#1e1e1ee6] font-bold'>a) General</h4>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
        ...
        <h4 className='ml-[8px] text-[14px] text-[#1e1e1ee6] font-bold'>b) Resettlements</h4>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
        ...
        <h4 className='ml-[8px] text-[14px] text-[#1e1e1ee6] font-bold'>c) Non-runners, withdrawals and disqualifications</h4>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
        ...
        <h4 className='ml-[8px] text-[14px] text-[#1e1e1ee6] font-bold'>d) Winner with [named selection]' markets</h4>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
        ...
        <h3 className='mt-[16px_0] text-[18px] text-[#1e1e1ee6] font-bold'>3. Abandonments, Cancellations, Postponements</h3>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
        ...
        <h3 className='mt-[16px_0] text-[18px] text-[#1e1e1ee6] font-bold'>4. Change of venue</h3>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
            Some markets have different rules and these are listed in the Specific
        ...
        <h3 className='mt-[16px_0] text-[18px] text-[#1e1e1ee6] font-bold'>5. Periods of time</h3>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
            Some markets have different rules and these are listed in the Specific
        ...
        <h3 className='mt-[16px_0] text-[18px] text-[#1e1e1ee6] font-bold'>6. Match bets</h3>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
            Some markets have different rules and these are listed in the Specific
        ...
        <h3 className='mt-[16px_0] text-[18px] text-[#1e1e1ee6] font-bold'>7. "To qualify" markets</h3>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
            Some markets have different rules and these are listed in the Specific
            Sports Rules and/or the Market Information. However, if not dealt with in
        ...
        <h3 className='mt-[16px_0] text-[18px] text-[#1e1e1ee6] font-bold'>8. Dead heats</h3>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
        ...
        <h3 className='mt-[16px_0] text-[18px] text-[#1e1e1ee6] font-bold'>9. Exchange Multiples</h3>
        ...
        <h3 className='mt-[16px_0] text-[18px] text-[#1e1e1ee6] font-bold'>10. Rules for Starting Price</h3>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
        ...
        <h4 className='ml-[8px] text-[14px] text-[#1e1e1ee6] font-bold'>➢ Party against whom you are betting at SP</h4>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
        ...
        <h4 className='ml-[8px] text-[14px] text-[#1e1e1ee6] font-bold'>➢ Placing a SP bet</h4>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
        ...
        <h4 className='ml-[8px] text-[14px] text-[#1e1e1ee6] font-bold'>➢ Exchange bets which are unmatched at the 'off'</h4>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
        ...
        <h4 className='ml-[8px] text-[14px] text-[#1e1e1ee6] font-bold'>➢ Adjustments to SP bets for non-runners</h4>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
        ...
        <h3 className='mt-[16px_0] text-[18px] text-[#1e1e1ee6] font-bold'>11. 'Keep' bets option</h3>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
        ...
        <h3 className='mt-[16px_0] text-[18px] text-[#1e1e1ee6] font-bold'>12. Rules for Tote betting</h3>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
        ...
        <h3 className='mt-[16px_0] text-[18px] text-[#1e1e1ee6] font-bold'>13. Miscellaneous</h3>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
        ...
        <h2 className='m-[16px_0] p-0 text-[20px] text-[#1b2d38] font-bold border-b border-[#ccc] pb-[8px]'>Part C - Specific sports rules</h2>
        <h3 className='mt-[16px_0] text-[18px] text-[#1e1e1ee6] font-bold'>1. American Football</h3>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
        ...
        <h3 className='mt-[16px_0] text-[18px] text-[#1e1e1ee6] font-bold'>2. Athletics</h3>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
        ...
        <h3 className='mt-[16px_0] text-[18px] text-[#1e1e1ee6] font-bold'>3. Australian Rules Football</h3>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
        ...
        <h3 className='mt-[16px_0] text-[18px] text-[#1e1e1ee6] font-bold'>4. Baseball</h3>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
        ...
        <h3 className='mt-[16px_0] text-[18px] text-[#1e1e1ee6] font-bold'>5. Basketball</h3>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
        ...
        <h3 className='mt-[16px_0] text-[18px] text-[#1e1e1ee6] font-bold'>6. Boxing and Mixed Martial Arts</h3>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
        ...
        <h3 className='mt-[16px_0] text-[18px] text-[#1e1e1ee6] font-bold'>7. Cricket</h3>
        <h4 className='ml-[8px] text-[14px] text-[#1e1e1ee6] font-bold'>➢ General</h4>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
        ...
        <h4 className='ml-[8px] text-[14px] text-[#1e1e1ee6] font-bold'>➢ Test matches</h4>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
        ...
        <h4 className='ml-[8px] text-[14px] text-[#1e1e1ee6] font-bold'>➢ Limited Over matches</h4>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
        ...
        <h4 className='ml-[8px] text-[14px] text-[#1e1e1ee6] font-bold'>➢ Super Over rule</h4>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
        ...
        <h3 className='mt-[16px_0] text-[18px] text-[#1e1e1ee6] font-bold'>8. Cycling</h3>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
            Where there is a presentation ceremony, markets will be settled on the
            official result of the relevant governing body at the time of the
        ...
        <h3 className='mt-[16px_0] text-[18px] text-[#1e1e1ee6] font-bold'>9. Darts</h3>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
        ...
        <h3 className='mt-[16px_0] text-[18px] text-[#1e1e1ee6] font-bold'>10. Financial markets</h3>
        <h4 className='ml-[8px] text-[14px] text-[#1e1e1ee6] font-bold'>➢ Indices</h4>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
        ...
        <h4 className='ml-[8px] text-[14px] text-[#1e1e1ee6] font-bold'>➢ Equities</h4>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
        ...
        <h4 className='ml-[8px] text-[14px] text-[#1e1e1ee6] font-bold'>➢ Interest Rates</h4>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
        ...
        <h3 className='mt-[16px_0] text-[18px] text-[#1e1e1ee6] font-bold'>11. House Price</h3>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
        ...
        <h4 className='ml-[8px] text-[14px] text-[#1e1e1ee6] font-bold'>➢ Currency markets</h4>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
        ...
        <h3 className='mt-[16px_0] text-[18px] text-[#1e1e1ee6] font-bold'>12. Golf</h3>
        <h4 className='ml-[8px] text-[14px] text-[#1e1e1ee6] font-bold'>➢ General</h4>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
        ...
        <h4 className='ml-[8px] text-[14px] text-[#1e1e1ee6] font-bold'>➢ Tournament match betting (i.e. 72-hole match bets)</h4>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
        ...
        <h4 className='ml-[8px] text-[14px] text-[#1e1e1ee6] font-bold'>➢ Round betting markets (e.g. 2 balls, 3 balls etc.)</h4>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
        ...
        <h3 className='mt-[16px_0] text-[18px] text-[#1e1e1ee6] font-bold'>13. Greyhound racing</h3>
        <h4 className='ml-[8px] text-[14px] text-[#1e1e1ee6] font-bold'>➢ General</h4>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
        ...
        <h4 className='ml-[8px] text-[14px] text-[#1e1e1ee6] font-bold'>➢ Trap Challenge</h4>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
        ...
        <h4 className='ml-[8px] text-[14px] text-[#1e1e1ee6] font-bold'>➢ Multi-trap or Multiplied Trap Numbers</h4>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
        ...
        <h4 className='ml-[8px] text-[14px] text-[#1e1e1ee6] font-bold'>➢ Winning Distances</h4>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
        ...
        <h4 className='ml-[8px] text-[14px] text-[#1e1e1ee6] font-bold'>➢ Match Bets</h4>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
        ...
        <h4 className='ml-[8px] text-[14px] text-[#1e1e1ee6] font-bold'>➢ Reverse Forecasts</h4>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
        ...
        <h4 className='ml-[8px] text-[14px] text-[#1e1e1ee6] font-bold'>➢ Place markets</h4>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
        ...
        <h4 className='ml-[8px] text-[14px] text-[#1e1e1ee6] font-bold'>➢ To Reach the Final and To Qualify markets</h4>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
        ...
        <h4 className='ml-[8px] text-[14px] text-[#1e1e1ee6] font-bold'>➢ Ante-post</h4>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
        ...
        <h4 className='ml-[8px] text-[14px] text-[#1e1e1ee6] font-bold'>➢ Australian Specific Non-Runner Rules</h4>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
        ...
        <h3 className='mt-[16px_0] text-[18px] text-[#1e1e1ee6] font-bold'>14. Horseracing</h3>
        <h4 className='ml-[8px] text-[14px] text-[#1e1e1ee6] font-bold'>➢ General</h4>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
        ...
        <h4 className='ml-[8px] text-[14px] text-[#1e1e1ee6] font-bold'>➢ Place Terms for Exchange markets</h4>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
            The number of winners in 'to be placed' markets is as set out in the
            Market Information and is determined with reference to the number of
        ...
        <h4 className='ml-[8px] text-[14px] text-[#1e1e1ee6] font-bold'>➢ EW markets</h4>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
        ...
        <h4 className='ml-[8px] text-[14px] text-[#1e1e1ee6] font-bold'>➢ Winning Distance Bets</h4>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
        ...
        <h4 className='ml-[8px] text-[14px] text-[#1e1e1ee6] font-bold'>➢ Non-Runner Rule</h4>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
        ...
        <h4 className='ml-[8px] text-[14px] text-[#1e1e1ee6] font-bold'>➢ How the Reductions are applied for Exchange markets</h4>
        <ul className='list-disc ml-[32px] mb-[16px]'>
        ...
        <h4 className='ml-[8px] text-[14px] text-[#1e1e1ee6] font-bold'>➢ Additional rules</h4>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
        ...
        <h3 className='mt-[16px_0] text-[18px] text-[#1e1e1ee6] font-bold'>15. Ice Hockey</h3>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
        ...
        <h3 className='mt-[16px_0] text-[18px] text-[#1e1e1ee6] font-bold'>16. Rowing</h3>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
        ...
        <h3 className='mt-[16px_0] text-[18px] text-[#1e1e1ee6] font-bold'>17. Rugby Union and Rugby League</h3>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
        ...
        <h3 className='mt-[16px_0] text-[18px] text-[#1e1e1ee6] font-bold'>18. Snooker and Pool</h3>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
        ...
        <h3 className='mt-[16px_0] text-[18px] text-[#1e1e1ee6] font-bold'>19. Soccer</h3>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
            If it does not suspend a market on time for the occurrence of a Material
            Event, it reserves the right to void bets unfairly matched after the
        ...
        <h3 className='mt-[16px_0] text-[18px] text-[#1e1e1ee6] font-bold'>20. Swimming</h3>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
            Where there is a presentation ceremony, markets will be settled on the
            official result of the relevant governing body at the time of the
        ...
        <h3 className='mt-[16px_0] text-[18px] text-[#1e1e1ee6] font-bold'>21. Tennis</h3>
        <ul className='list-disc ml-[32px] mb-[16px]'>
          <li>
        ...
        <h3 className='mt-[16px_0] text-[18px] text-[#1e1e1ee6] font-bold'>
