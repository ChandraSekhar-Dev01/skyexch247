  ...
  return (
    <div className="fixed top-0 w-full h-full m-0 bg-[#fff] rounded-none shadow-none">
      ...
      <div className="p-[16px_24px] mt-[40px] text-[14px] leading-[24px] overflow-y-scroll h-[95vh]">
        <h2 className='text-[20px] text-[#1b2d38] font-bold m-[16px_0] pb-[8px] border-b border-dotted border-[#ccc] leading-[20px]'>Description: Initial Terms and Conditions replacing general rules</h2>
        <h3 className='text-[18px] text-[#1e1e1ee6] font-bold mt-[16px] mb-[8px] leading-[24px]'>Introduction</h3>
        <p className="mb-3">
          ...
          URL https://www.skyech.art/&nbsp;(the “Website”) and its related or
          connected services (collectively, the “Service”) will be provided to you.
        </p>
        <p className="mb-3">
        ...
        <p className="mb-3">The Service is supplied by Sky Infotech N.V.</p>
        <p className="mb-3">
        ...
        <h3 className='text-[18px] text-[#1e1e1ee6] font-bold mt-[16px] mb-[8px] leading-[24px]'>2. Registration</h3>
        <p className="mb-3">You agree that at all times when using the service:</p>
        <p className="mb-3">
        ...
        <h3 className='text-[18px] text-[#1e1e1ee6] font-bold mt-[16px] mb-[8px] leading-[24px]'>3. Restricted Use</h3>
        <p className="mb-3">3.1 You must not use the Service:</p>
        <p className="mb-3">
        ...
        <p className="mb-3">for any unlawful activity whatsoever.</p>
        <p className="mb-3">
          3.2 You cannot sell or transfer your account to third parties, nor can you
          acquire a player account from a third party.
        </p>
        <p className="mb-3">3.3 You may not, in any manner, transfer funds between player accounts.</p>
        <p className="mb-3">
        ...
        <h3 className='text-[18px] text-[#1e1e1ee6] font-bold mt-[16px] mb-[8px] leading-[24px]'>4. Privacy</h3>
        <p className="mb-3">
        ...
        <p className="mb-3">We do not give credit for the use of the service.</p>
        <p className="mb-3">
        ...
        <p className="mb-3">Funds originating from ill-gotten means must not be deposited with us.</p>
        <h3 className='text-[18px] text-[#1e1e1ee6] font-bold mt-[16px] mb-[8px] leading-[24px]'>7. Withdrawal of Funds</h3>
        <p className="mb-3">
        ...
        <h3 className='text-[18px] text-[#1e1e1ee6] font-bold mt-[16px] mb-[8px] leading-[24px]'>9. Errors</h3>
        <p className="mb-3">
        ...
        <h3 className='text-[18px] text-[#1e1e1ee6] font-bold mt-[16px] mb-[8px] leading-[24px]'>10. General Rules</h3>
        <p className="mb-3">
        ...
        <h3 className='text-[18px] text-[#1e1e1ee6] font-bold mt-[16px] mb-[8px] leading-[24px]'>11. Communications and Notices</h3>
        <p className="mb-3">
        ...
        <h3 className='text-[18px] text-[#1e1e1ee6] font-bold mt-[16px] mb-[8px] leading-[24px]'>13. Liability</h3>
        <p className="mb-3">
        ...
        <p className="mb-3">(I) YOUR OWN FAULT;</p>
        <p className="mb-3">
        ...
        <p className="mb-3">(B) EUR €500 IN AGGREGATE, WHICHEVER IS LOWER.</p>
        <p className="mb-3">
        ...
        <h3 className='text-[18px] text-[#1e1e1ee6] font-bold mt-[16px] mb-[8px] leading-[24px]'>14. Gambling By Those Under Age</h3>
        <p className="mb-3">
        ...
        <h3 className='text-[18px] text-[#1e1e1ee6] font-bold mt-[16px] mb-[8px] leading-[24px]'>15. Fraud</h3>
        <p className="mb-3">
        ...
        <p className="mb-3">
          The <a href="mailto:https://www.skyech.art/">https://www.skyech.art/</a>{" "}
        ...
        <h3 className='text-[18px] text-[#1e1e1ee6] font-bold mt-[16px] mb-[8px] leading-[24px]'>17. Your Licence</h3>
        <p className="mb-3">
        ...
        <h3 className='text-[18px] text-[#1e1e1ee6] font-bold mt-[16px] mb-[8px] leading-[24px]'>18. Your Conduct and Safety</h3>
        <p className="mb-3">
        ...
        <h3 className='text-[18px] text-[#1e1e1ee6] font-bold mt-[16px] mb-[8px] leading-[24px]'>19. Links to Other Websites</h3>
        <p className="mb-3">
        ...
        <h3 className='text-[18px] text-[#1e1e1ee6] font-bold mt-[16px] mb-[8px] leading-[24px]'>20. Complaints</h3>
        <p className="mb-3">
        ...
        <h3 className='text-[18px] text-[#1e1e1ee6] font-bold mt-[16px] mb-[8px] leading-[24px]'>21. Registration and Account Security</h3>
        <p className="mb-3">
        ...
        <h3 className='text-[18px] text-[#1e1e1ee6] font-bold mt-[16px] mb-[8px] leading-[24px]'>22. Assignment</h3>
        <p className="mb-3">
        ...
        <h3 className='text-[18px] text-[#1e1e1ee6] font-bold mt-[16px] mb-[8px] leading-[24px]'>23. Severability</h3>
        <p className="mb-3">
        ...
        <h3 className='text-[18px] text-[#1e1e1ee6] font-bold mt-[16px] mb-[8px] leading-[24px]'>24. Breach of These Terms</h3>
        <p className="mb-3">
        ...
        <h3 className='text-[18px] text-[#1e1e1ee6] font-bold mt-[16px] mb-[8px] leading-[24px]'>25. Governing Law and Jurisdiction</h3>
        <p className="mb-3">
        ...
        <h3 className='text-[18px] text-[#1e1e1ee6] font-bold mt-[16px] mb-[8px] leading-[24px]'>Casino Payout restrictions</h3>
        <ul>
          <li>
