      ...
      <div className="fixed top-0 w-full h-full m-0 bg-[#fff] rounded-none shadow-none">
        ...
        <div className="p-[16px_24px] mt-[40px] text-[14px] leading-[24px] overflow-y-scroll h-[95vh]">
          <p className="mb-3">
            ...
            personal information and how we use it. Where you have choices or rights,
          ...
          <p className="mb-3">
            ...
            funds will be deemed confirmation of your full agreement with our Terms
            and Conditions and our Privacy Policy. You have the right to cease using
            the website at any time; however, we may still be legally required to
            retain some of your personal information.
          </p>
          <p className="mb-3">
            We may periodically make changes to this Privacy Policy and will notify
            you of these changes by posting the modified terms on our platforms. We
          ...
          <p className="mb-3">
            ...
            information is required to give you access to certain parts of our website
          ...
          <p className="mb-3">The information includes your:</p>
          <ul className="list-disc pl-5 mb-3">
            <li>Username</li>
          ...
          <h3 className='text-[18px] text-[#1e1e1ee6] font-bold mt-[16px] mb-[8px] leading-[24px]'>Telephone Calls</h3>
          <p className="mb-3">
          ...
          <p className="mb-3">
            ...
            address, time of access, date of access, web page(s) visited, language
            use, software crash reports and type of browser used. This information is
          ...
          <h2 className='text-[20px] text-[#1b2d38] font-bold m-[16px_0] pb-[8px] border-b border-dotted border-[#ccc] leading-[20px]'>How and why we use your personal information</h2>
          <p className="mb-3">
          ...
          <h2 className='text-[20px] text-[#1b2d38] font-bold m-[16px_0] pb-[8px] border-b border-dotted border-[#ccc] leading-[20px]'>Providing our products and services</h2>
          <p className="mb-3">
          ...
          <p className="mb-3">
            <strong>
              This category covers the essential activities required in order for us
              to provide you with the services you use or have signed up for. If you
              don't want your information used in this way, your option is to not use
          ...
          <p className="mb-3">
            ...
            financial transactions for potential breach of our Terms and Conditions
            and of applicable law. Security reviews may include but are not limited to
            ordering a credit report and/or otherwise verifying the information you
            provide against third-party databases.
          </p>
          <p className="mb-3">
            <strong>
              We are required to carry out these activities to provide our products
              and services legally, responsibly, and in line with the requirements
              stipulated by regulators. We cannot provide you with our services
              without carrying out these activities, if you don't want your
              information used in this way, your option is to not use our services and
              close your account.
            </strong>
          </p>
          <h2 className='text-[20px] text-[#1b2d38] font-bold m-[16px_0] pb-[8px] border-b border-dotted border-[#ccc] leading-[20px]'>To monitor our website performance</h2>
          <p className="mb-3">
            As detailed above, we use cookies and traffic analysis in order to improve
            the performance of our website and services available. We have a
            legitimate interest in carrying out these activities and we ensure that we
            minimise any impact on your privacy.
          </p>
          <p className="mb-3">
            <strong>
              ...
              central to our business, if you wish to object further than managing
              your cookies this may mean you need to close your account.
            </strong>
          </p>
          <h2 className='text-[20px] text-[#1b2d38] font-bold m-[16px_0] pb-[8px] border-b border-dotted border-[#ccc] leading-[20px]'>Marketing</h2>
          <p className="mb-3">
          ...
          <h2 className='text-[20px] text-[#1b2d38] font-bold m-[16px_0] pb-[8px] border-b border-dotted border-[#ccc] leading-[20px]'>Your rights</h2>
          <h3 className='text-[18px] text-[#1e1e1ee6] font-bold mt-[16px] mb-[8px] leading-[24px]'>Your rights to rectification</h3>
          <p className="mb-3">
          ...
          <p className="mb-3">
            ...
            you for valid proof of identity and once we've received it we will provide
            our response within one month. If your request is unusually complex and
            likely to take longer than a month, we will let you know as soon as we can
            and tell you how long we think it will take, such request may also incur
            an administration cost.
          </p>
          <h3 className='text-[18px] text-[#1e1e1ee6] font-bold mt-[16px] mb-[8px] leading-[24px]'>Your right of erasure</h3>
          <p className="mb-3">
          ...
          <p className="mb-3">
            ...
            research historical research or statistical purposes where erasure is
            likely to render impossible or seriously impair the achievement of that
            processing; or *for the establishment, exercise or defence of legal
            claims.
          </p>
          <h2 className='text-[20px] text-[#1b2d38] font-bold m-[16px_0] pb-[8px] border-b border-dotted border-[#ccc] leading-[20px]'>Sharing your personal information</h2>
          <p className="mb-3">We may disclose your Personal Data to third parties:</p>
          <ul className="list-disc pl-5 mb-3">
            <li>
            ...
            <li>
              ...
              request, including but not limited to third party software providers;
            </li>
            <li>
            ...
            <li>
              for the purpose of research on the prevention of addiction (this data
          ...
          <p className="mb-3">
            ...
            facilities. By using our services, you expressly consent to any transfer
            of information outside of your country. When we transfer any part of your
          ...
          <h3 className='text-[18px] text-[#1e1e1ee6] font-bold mt-[16px] mb-[8px] leading-[24px]'>Security</h3>
          <p className="mb-3">
            We understand the importance of security and the techniques needed to
            secure information. We store all of the Personal Information we receive
            directly from you in an encrypted and password protected database residing
            within our secure network behind active state-of-the-art firewall
            software. (Our Services support SSL Version 3 with 128-bit encryption). We
            also take measures to ensure our subsidiaries, agents, affiliates and
            suppliers employ adequate security measures.
          </p>
          <h3 className='text-[18px] text-[#1e1e1ee6] font-bold mt-[16px] mb-[8px] leading-[24px]'>Retention</h3>
          <p className="mb-3">
          ...
          <h3 className='text-[18px] text-[#1e1e1ee6] font-bold mt-[16px] mb-[8px] leading-[24px]'>Third-Party Practices</h3>
          <p className="mb-3">
            ...
            online sites are owned and operated independently from us. Any information
            collected by these third parties is governed by the privacy policy, if
            any, of such third party.
          </p>
          <p className="mb-3">
            ...
            the operators of these websites shall be responsible for their
            functionality or possible errors on the linked sites.
          </p>
          <h3 className='text-[18px] text-[#1e1e1ee6] font-bold mt-[16px] mb-[8px] leading-[24px]'>Analytics</h3>
          <p className="mb-3">
          ...
          <p className="mb-3">Google Analytics (Google Inc.)</p>
          <p className="mb-3">
          ...
          <p className="mb-3">Personal Data collected: Cookies and Usage Data</p>
          <h3 className='text-[18px] text-[#1e1e1ee6] font-bold mt-[16px] mb-[8px] leading-[24px]'>Disclaimer</h3>
          <p className="mb-3">
            ...
            cannot guarantee, nor do we claim that there will be error-free
            performance regarding the privacy of your Personal Information, and we
            will not be liable for any indirect, incidental, consequential or punitive
            damages relating to the use or release of said Personal Information.
          </p>
          <h2 className='text-[20px] text-[#1b2d38] font-bold m-[16px_0] pb-[8px] border-b border-dotted border-[#ccc] leading-[20px]'>Changes to our Privacy Statement</h2>
          <p className="mb-3">
          ...
          <p className="mb-3">
            ...
            Policy, or otherwise do not accept the changes within the time period, we
            may not be able to continue to provide some or all products and services.
          </p>
        </div>
      </div>
    </>
