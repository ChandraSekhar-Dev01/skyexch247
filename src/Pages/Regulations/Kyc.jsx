  ...
  return (
    <div className="fixed top-0 w-full h-full m-0 bg-[#fff] rounded-none shadow-none">
      ...
      <div className="p-[16px_24px] mt-[40px] text-[14px] leading-[24px] overflow-y-scroll h-[95vh]">
        <h3 className='mt-[16px] mb-[8px] text-[18px] text-[#1e1e1ee6] font-bold'>KNOW YOUR CUSTOMER POLICY</h3>
        <p className='mb-[12px]'>
        ...
        <h3 className='mt-[16px] mb-[8px] text-[18px] text-[#1e1e1ee6] font-bold'>Why do I need to provide documentation?</h3>
        <p className='mb-[12px]'>There are several reasons:</p>
        <p className='mb-[12px]'>
        ...
        <h3 className='mt-[16px] mb-[8px] text-[18px] text-[#1e1e1ee6] font-bold'>WHAT DOCUMENTS DO I NEED TO PROVIDE?</h3>
        <p className='mb-[12px]'>PROOF OF ID:</p>
        <p className='mb-[12px]'>
          A color copy of a valid government issued form of ID (Driver's License,
          Passport, State ID or Military ID)
        </p>
        <h3 className='mt-[16px] mb-[8px] text-[18px] text-[#1e1e1ee6] font-bold'>PROOF OF ADDRESS:</h3>
        <p className='mb-[12px]'>A copy of a recent utility bill showing your address</p>
        <p className='mb-[12px]'>
        ...
        <h3 className='mt-[16px] mb-[8px] text-[18px] text-[#1e1e1ee6] font-bold'>When do I need to provide these documents?</h3>
        <p className='mb-[12px]'>
        ...
        <h3 className='mt-[16px] mb-[8px] text-[18px] text-[#1e1e1ee6] font-bold'>How can I send you these documents?</h3>
        <p className='mb-[12px]'>
        ...
        <h3 className='mt-[16px] mb-[8px] text-[18px] text-[#1e1e1ee6] font-bold'>How do I know my documents are safe with you?</h3>
        <p className='mb-[12px]'>
