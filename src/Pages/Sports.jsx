  ...
  return (
    <>
      ...
      <div className='block lg:hidden'>
        ...
        <div className='relative flex [background-image:linear-gradient(180deg,_#ffcc2e_0%,_#ffbd14_100%)]'>
          <div className="flex flex-nowrap gap-2 pl-1 pr-5 pt-3 overflow-x-auto w-[90%] whitespace-nowrap">
            <span className={`flex justify-center items-center gap-2 ${selectedSport == "4" ? '[background-image:linear-gradient(180deg,_#474747_0%,_#070707_100%)] text-[#ffb200]' : 'text-[#000]'} px-2 py-[10px] rounded-t-md text-sm font-semibold`} onClick={() => setSelectedSport("4")}><img src={selectedSport == "4" ? '/Images/cricket-yellow.svg' : '/Images/cricket-black.svg'} alt="" className='w-5' /> Cricket</span>
            <span className={`flex justify-center items-center gap-2 ${selectedSport == "1" ? '[background-image:linear-gradient(180deg,_#474747_0%,_#070707_100%)] text-[#ffb200]' : 'text-[#000]'} px-2 py-[10px] rounded-t-md text-sm font-semibold`} onClick={() => setSelectedSport("1")}><img src={selectedSport == "1" ? '/Images/soccer-yellow.svg' : '/Images/soccer-black.svg'} alt="" className='w-5' /> Soccer</span>
            <span className={`flex justify-center items-center gap-2 ${selectedSport == "2" ? '[background-image:linear-gradient(180deg,_#474747_0%,_#070707_100%)] text-[#ffb200]' : 'text-[#000]'} px-2 py-[10px] rounded-t-md text-sm font-semibold`} onClick={() => setSelectedSport("2")}><img src={selectedSport == "2" ? '/Images/tennis-yellow.svg' : '/Images/tennis-black.svg'} alt="" className='w-5' /> Tennis</span>
            <span className={`flex justify-center items-center gap-2 ${selectedSport == "0" ? '[background-image:linear-gradient(180deg,_#474747_0%,_#070707_100%)] text-[#ffb200]' : 'text-[#000]'} px-2 py-[10px] rounded-t-md text-sm font-semibold`} onClick={() => setSelectedSport("0")}><img src={selectedSport == "0" ? '/Images/e-soccer-yellow.svg' : '/Images/e-soccer-black.svg'} alt="" className='w-5' /> E-Soccer</span>
          </div>
          <div className='absolute right-0 w-[12.8vw] h-[12.2666666667vw] flex justify-center items-center [background-image:linear-gradient(180deg,_#525252_0%,_#2d2d2d_100%)]'>
            <img src="/Images/search-icon.svg" alt="" className=' [background-image:linear-gradient(90deg, rgba(0, 0, 0, 0) 0%, #000000 110%)]' />
          </div>
        </div>
        <div>
          <span className='flex justify-center items-center p-2 [background-image:linear-gradient(-180deg,_#2e4b5e_0%,_#243a48_82%)] text-base text-white font-bold'>Highlights</span>
          <div className='flex justify-center items-center p-1'>
            <span className="flex justify-center item-center text-sm font-bold text-[#0074c4] bg-white shadow-[0_0_3px_0_rgba(0,0,0,0.15)] rounded py-2 w-[40%]">
              by Time
            </span>
            <span className="flex justify-center item-center text-sm font-bold text-black bg-[#e3e3e3] shadow-[inset_0_1px_3px_0_rgba(0,0,0,0.15)] rounded py-2 w-[40%]">
              by Competition
            </span>
          </div>
