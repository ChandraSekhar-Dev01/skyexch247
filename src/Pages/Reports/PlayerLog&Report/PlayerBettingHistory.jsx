...
function PlayerBettingHistory() {
  const [selectMarket, setSelectMarket] = useState("1");
  return (
    <>
      <h2 className='flex w-full text-[13px] text-[#243a48] leading-[20px] font-bold pt-[6px] mb-[6px]'>Betting History</h2>
      <div className=' my-[15px] text-[12px] text-[#3b5160] leading-[15px]'>
        <div className='m-[13px_0_10px_0] block clear-both'>
          <ul className='mb-0 mr-[20px] float-left'>
            <li className='m-[0_5px_0_0] leading-[32px] whitespace-nowrap block float-left'>
              <input type="text" size={50} placeholder='enter betId...' className='h-[32px] m-[0_5px_0_5px] text-[#1e1e1e] text-[12px] bg-[#fff] rounded p-[5px] box-border border border-[#aaa] shadow-[inset_0px_2px_0px_#0000001a]' />
            </li>
            <li className="m-[0_5px_5px_0] whitespace-nowrap float-left">
              <span className="block min-w-[95px] h-[32px] text-[12px] text-[#ffb600] font-bold leading-[30px] text-center bg-[linear-gradient(180deg,_#474747_0%,_#070707_100%)] shadow-initial border border-[#222] rounded-[4px]">
                Submit
              </span>
            </li>
            <li className='m-0 leading-[32px] whitespace-nowrap'>Multiple of betIds querie can be entered (e.g. 12,345,6789)</li>
            <span className='block clear-both'></span>
          </ul>
          <span className='block clear-both'></span>
        </div>
        <hr width="100%" size={1} color="#7e97a7" />

        <ul className='flex my-[15px] leading-[15px]'>
...
export default PlayerBettingHistory