      ...
      <div className='flex w-full lg:max-w-[1320px] m-[0_auto] mt-[1px]'>
        ...
        <div className='hidden lg:block w-full lg:w-[23.361111%]'>
          <ul className='border-b border-[#7e97a7]'>
            ...
            <li className={`text-xs ${locationState?.state == "bets" ? "text-[#fff] bg-[#0009]" : "text-black bg-white"} border-b border-[#eee1c0] w-full py-1 px-2 cursor-pointer`} onClick={() => navigate('/profile', { state: { state: 'bets', eventType: 'cb' } })}>
              <span>My Bets</span>
            </li>
