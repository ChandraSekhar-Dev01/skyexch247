        ...
        <div className='relative bg-[#efebe6] py-3 lg:col-span-4 lg:rounded-md lg:shadow-xl lg:bg-[#efebe6e6] lg:pt-0 lg:pb-3 md:SANA:bg-tertiary'>
          <div className='flex items-center text-[#663333] font-bold px-3 pt-2 pb-2 sticky z-20 top-0 bg-[#efebe6] lg:bg-transparent lg:top-[42px] lg:pt-3 lg:mb-2 lg:SANA:border-b lg:SANA:border-gray-200'>
            ...
            <div className='flex-none relative'>
              <div className='flex items-center bg-[#fbf7f1] py-1 px-2 cursor-pointer SANA:rounded-full SANA:border-fifth SANA:border'>
                <img src="/Images/skyLobby/filter-brown.webp" alt="" className='overflow-hidden w-6 h-6' />
                ...
                <img src="/Images/skyLobby/arrow-down-brown.webp" alt="" className='overflow-hidden w-6 h-6 px-0.5 py-1 bg-center bg-no-repeat border-l border-[#663333]' />
              </div>
            </div>
