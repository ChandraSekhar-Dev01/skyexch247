...
function SubGames() {
  ...
  return (
    <>
      <div className='pb-[4rem] bg-cover lg:pb-0 IN2:bg-index-red IN2:bg-fixed SANA:bg-index-blue SANA:bg-fixed' style={{ backgroundImage: "url('/Images/skyLobby/bg-platform.jpg')" }}>
        <div className='sticky top-0 lg:top-nav-desktop z-20 bg-cover min-h-[110px] overflow-hidden lg:overflow-visible IN2:bg-gradient-to-b IN2:from-secondary IN2:to-fourth IN2:backdrop-blur-sm SANA:bg-secondary SANA:bg-none' style={{ backgroundImage: "url('/Images/skyLobby/bg-platform1.jpg')" }}>
            ...
            <div className='absolute right-5 top-5 lg:left-8 lg:top-12 lg:IN2:left-10 lg:IN2:top-16'>
              <div className="relative w-20 h-20 p-0.5 bg-[linear-gradient(to_right_top,_#654302,_#f7c972,_#644202,_#f7c972,_#694809,_#f7c972,_#6f4d0c)] rounded-full lg:IN2:w-20 lg:IN2:h-20 IN2:bg-transparent lg:IN2:p-0 SANA:bg-none">
                <div className='p-2 bg-black rounded-full min-h-[60px] lg:IN2:rounded-lg SANA:rounded-md SANA:bg-none SANA:bg-fifth SANA:shadow-sm'>
                  <img src="/Images/skyLobby/JDB.png" alt="" className='block align-middle w-full max-w-full h-auto' />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className='sticky top-[110px] z-20 bg-[linear-gradient(to_bottom,#665030,#1c1202)] flex lg:col-span-4 lg:max-w-5xl lg:top-32 lg:mx-auto lg:rounded-full lg:overflow-hidden text-sm'>
          <div className={`p-2 flex-1 text-center md:flex items-center lg:max-w-[165px] lg:hover:bg-[#00000020] ${filterData == "All" ? "bg-center text-[#ffcd79]" : "text-[#9e9e9e]"}`} style={{ backgroundImage: filterData == "All" && "url('/Images/skyLobby/nav-active-bg.webp')", backgroundSize: "100% 100%" }} onClick={() => setFilterData('All')}>
            All
          </div>
          <div className={`p-2 flex-1 text-center md:flex items-center lg:max-w-[165px] lg:hover:bg-[#00000020] ${filterData == "slot" ? "bg-center text-[#ffcd79]" : "text-[#9e9e9e]"}`} style={{ backgroundImage: filterData == "slot" && "url('/Images/skyLobby/nav-active-bg.webp')", backgroundSize: "100% 100%" }} onClick={() => setFilterData('slot')}>
            Slot
          </div>
          <div className={`p-2 flex-1 text-center md:flex items-center lg:max-w-[165px] lg:hover:bg-[#00000020] ${filterData == "fishing" ? "bg-center text-[#ffcd79]" : "text-[#9e9e9e]"}`} style={{ backgroundImage: filterData == "fishing" && "url('/Images/skyLobby/nav-active-bg.webp')", backgroundSize: "100% 100%" }} onClick={() => setFilterData('fishing')}>
            Fishing
          </div>
        </div>
          ...
          <div className='relative flex flex-wrap mx-1 md:mx-4 lg:max-w-7xl lg:mx-auto mt-5 text-[#d5b565]'>
            <div className='relative flex-none p-1 mb-3 w-[33.333333%] md:w-[calc(100%/6)] lg:w-[12.5%] min-w-[114px] cursor-pointer'>
              ...
              <div className='relative mb-3'>
                ...
                <img src="/Images/skyLobby/JDB-FISH-008.png" alt="" className='absolute p-2 w-full h-full block align-middle' />
